...
if(!file_exists('config.json')){
	...
	$token = readline('Hi sufi Kareem inter token: ');
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			...
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  ...
                  'photo'=>"https://t.me/potoqq/54",

                   'caption'=>'تم البرمجة بواسطة (@BXSBXS)' ,
...
if($text == '/BBOBB'){
              ...
              'caption'=>'هاك اتونس',
                      ...
                      'inline_keyboard'=>[                       
                       ...
                       [['text'=>"اشترك بهاي القناة وياك ", 'url'=>"https://t.me/BOBBB"]],
          		...
          		if($mode == 'addL'){
          			...
          			if(isset($body->message)){
          				...
          				$keyboard = ['inline_keyboard'=>[
										...
										[['text'=>"X- اضافة حساب جديد -X",'callback_data'=>'addL']]
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'text'=>"حجي هاي صفحة التحكم مالتك اي شي تريدة راسل   - @BXSBXS",
                  ...
                  'reply_markup'=>json_encode([
                      ...
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'تشغيل البوت ▶️','callback_data'=>'run'],['text'=>'ايقاف البوت ⏸','callback_data'=>'stop']],
                              ...
                              [['text'=>' Tele','url'=>'t.me/BXSBXS'],['text'=>' Ch ','url'=>'t.me/IBqBoT']],
					...
					$bot->sendMessage([
							...
							'text'=> "حبي البوت مو مجاني البوت مدفوع اذا تريد تشترك لو تريد نسخة خاصة راسل مصطفى @bbobb",

                  'reply_markup'=>json_encode([

                      'inline_keyboard'=>[

                      [['text'=>'Mustafa Kareem 🕸','url'=>'t.me/bobbb']]

                      [['text'=>'▪️| قناة صيد المشتركين','url'=>'t.me/bbobb']]
              ...
              $bot->editMessageText([
          	  ...
          	  $bot->editMessageText([
                      ...
                      'message_id'=>$mid,
                       ...
                       'text'=>"ها سيد منورني مرة ثانية المهم اختار شتريد منجوة👇",
