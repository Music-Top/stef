...
~ @X_Q_9 🍂',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                       ...
                       [['text'=>"المطور 🌝", 'url'=>"https://t.me/P_0_T"]],
                       [['text'=>"قناه البوت 🕵️", 'url'=>"t.me/StefTools"]],
                       ]
                  ])
              ]);   
          } 
          if($text == '/start'){
          	$bot->sendMessage([
                'chat_id'=>$chatId,
                'text'=>"ستيف موجود للمساعده لا تقلق ♥️
@P_0_T"
...
if($text == 'ستيف'){
              ...
              'video'=>"https://t.me/StefTools",
              'caption'=>'طرق السحبب☁️',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝐷𝐸𝑉𝐸𝐿𝑂𝑃𝐸𝑅 𓅔", 'url'=>"https://t.me/StefTools "]],
                       ]
                       ])
                       ]);
    
              $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/StefTools",
...
لشراء نسخه مراسلة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'𝐷𝐸𝑉𝐸𝐿𝑂𝑃𝐸𝑅','url'=>'t.me/StefTools']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/StefTools"]],
                  ]
							])
					]);
				}
            ...
            exec('screen -dmS gr php explore.php');
              ...
              $bot->editMessageText([
          	  ...
          	  $bot->editMessageText([
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                       'text'=>"𝙷𝙸 𝙱𝚁𝙾 𝙸𝙽 𝚃𝙷𝙴 𝙲𝙾𝙽𝚃𝚁𝙾𝙻 𝙱𝚈 ~ @P_0_T",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل حساب 🗡️','callback_data'=>'login']],
                          [['text'=>'انواع السحب 🧰','callback_data'=>'grabber']],
